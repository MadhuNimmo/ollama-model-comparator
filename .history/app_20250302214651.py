#!/usr/bin/env python3
"""
Minimal Ollama Model Comparator - Compare responses from different Ollama models
"""
...
def create_app():
    ...
    with gr.Blocks(title="Ollama Model Comparator") as app:
        ...
        def compare_models(model1_name, model2_name, sys_prompt, user_prompt, temp, max_tok, timeout_sec):
            ...
            # Since we can't update the UI from the thread in this version, we'll just do the requests
            # sequentially without streaming updates
