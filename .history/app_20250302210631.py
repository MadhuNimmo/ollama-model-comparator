...
def create_app():
    ...
    with gr.Blocks(title="Ollama Model Comparator", theme="default") as app:
    ...
    () => {
        ...
        style.textContent = `
            .model-output {
                ...
                /* Force a white background and dark text */
                background-color: #ffffff !important;
                color: #000000 !important;

                /* Ensure no partial transparency or filters */
                opacity: 1 !important;
                filter: none !important;
            }
            /* Also force the text inside markdown to be dark and fully opaque */
            .model-output * {
                color: #000000 !important;
                opacity: 1 !important;
